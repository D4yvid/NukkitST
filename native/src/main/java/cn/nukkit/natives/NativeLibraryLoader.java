...
public class NativeLibraryLoader {
    ...
    private static final LinkedHashMap<String, String> LOADED_LIBRARY_PATHS = new LinkedHashMap<>();
    ...
    public static boolean loadLibrary(ClassLoader loader, String libraryName) {
        if (LOADED_LIBRARY_PATHS.containsValue(libraryName)) {
            var path = Path.of(LOADED_LIBRARY_PATHS.get(libraryName));
        ...
        try {
            ...
            LOADED_LIBRARY_PATHS.put(libraryName, path);
    ...
    private static String extractLibrary(ClassLoader loader, String libraryName) {
        try {
            ...
            var jarLocation = new File(NativeLibraryLoader.class.getProtectionDomain()
                    .getCodeSource()
                    .getLocation()
