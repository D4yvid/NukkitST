...
import org.crimsonmc.inventory.BaseInventory;
import org.crimsonmc.inventory.ChestInventory;
import org.crimsonmc.inventory.DoubleChestInventory;
 ...
 */
public class BlockEntityChest extends BlockEntitySpawnable
    ...
    public BlockEntityChest getPair() {
        if (this.isPaired()) {
            BlockEntity blockEntity = this.getLevel().getBlockEntity(
