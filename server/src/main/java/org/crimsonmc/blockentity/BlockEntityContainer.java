...
public interface BlockEntityContainer {
    ...
    /**
     * 返回一个存储在容器里的物品的{@code Item}对象。<br> Returns an item that stores in this
     * container, as an {@code Item} object.
     *
     ...
     * Notice: If there is already an item for this index number, the new item being stored will
     * REPLACE the old one.</p>
     *
     * @param index 这个物品的索引序号。<br>The index number of this item.
     * @param item  描述这个物品的 {@code Item}对象。<br>The {@code Item} object that describes this
     *              item.
     * @since crimsonmc 1.0 | crimsonmc API 1.0.0
     */
    ...
    /**
     * 返回这个容器最多能包含的物品数量。<br> Returns the max number of items that this container can
     * contain.
     *
