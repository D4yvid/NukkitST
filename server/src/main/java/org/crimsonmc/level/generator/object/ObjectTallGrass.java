package org.crimsonmc.level.generator.object;
...
/**
 * author: ItsLucas crimsonmc Project
 */

public class ObjectTallGrass {

    public static void growGrass(ChunkManager level, Vector3 pos, RandomUtilities random, int count,
                                 int radius) {
        int[][] arr = {{Block.DANDELION, 0}, {Block.POPPY, 0}, {Block.TALL_GRASS, 1},
                {Block.TALL_GRASS, 1}, {Block.TALL_GRASS, 1}, {Block.TALL_GRASS, 1}};
