...
public abstract class ObjectTree {
    ...
    public static void growTree(ChunkManager level, int x, int y, int z, RandomUtilities random) {
    ...
    public boolean canPlaceObject(ChunkManager level, int x, int y, int z, RandomUtilities random) {
        int radiusToCheck = 0;
    ...
    protected void placeTrunk(ChunkManager level, int x, int y, int z, RandomUtilities random,
                              int trunkHeight) {
        // The base dirt block
