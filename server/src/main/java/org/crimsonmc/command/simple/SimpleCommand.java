package org.crimsonmc.command.simple;
...
public class SimpleCommand extends Command {
    ...
    public SimpleCommand(Object object, Method method, String name, String description,
                         String usageMessage, String[] aliases) {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        try {
            ...
            Server.getInstance().getLogger().exception(exception);
        }
