...
import org.crimsonmc.network.protocol.AdventureSettingsPacket;

/**
 * crimsonmc Project Author: MagicDroidX
 */
public class AdventureSettings implements Cloneable {
    ...
    public AdventureSettings clone(ServerPlayer newPlayer) {
        try {
