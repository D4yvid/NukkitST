...
/**
 * auth||: MagicDroidX crimsonmc Project
 */
public class AxisAlignedBB implements Cloneable {
    ...
    public AxisAlignedBB(double minX, double minY, double minZ, double maxX, double maxY,
                         double maxZ) {
        this.minX = minX;
        this.minY = minY;
        this.minZ = minZ;
    ...
    public AxisAlignedBB setBounds(double minX, double minY, double minZ, double maxX, double maxY,
                                   double maxZ) {
        this.minX = minX;
        this.minY = minY;
        this.minZ = minZ;
    ...
    public AxisAlignedBB grow(double x, double y, double z) {
        return new AxisAlignedBB(this.minX - x, this.minY - y, this.minZ - z, this.maxX + x,
    ...
    public boolean isVectorInside(Vector3 vector) {
        return vector.x >= this.minX && vector.x <= this.maxX && vector.y >= this.minY &&
                vector.y <= this.maxY && vector.z >= this.minZ && vector.z <= this.maxZ;
    }
    ...
    public boolean isVectorInYZ(Vector3 vector) {
        return vector.y >= this.minY && vector.y <= this.maxY && vector.z >= this.minZ &&
                vector.z <= this.maxZ;
    }

    public boolean isVectorInXZ(Vector3 vector) {
        return vector.x >= this.minX && vector.x <= this.maxX && vector.z >= this.minZ &&
                vector.z <= this.maxZ;
    }
    ...
    public MovingObjectPosition calculateIntercept(Vector3 pos1, Vector3 pos2) {
        ...
        // if (v1 != null && (vector == null || pos1.distanceSquared(v1) <
        // pos1.distanceSquared(vector))) {
        if (v1 != null) {
            vector = v1;
        }
    ...
    public String toString() {
        return "AxisAlignedBB(" + this.minX + ", " + this.minY + ", " + this.minZ + ", " + this.maxX +
                ", " + this.maxY + ", " + this.maxZ + ")";
    }
