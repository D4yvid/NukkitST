...
import org.crimsonmc.event.potion.PotionCollideEvent;
import org.crimsonmc.level.format.FullChunk;
import org.crimsonmc.level.particle.InstantSpellParticle;
import org.crimsonmc.level.particle.Particle;
import org.crimsonmc.level.particle.SpellParticle;
...
public class EntityPotion extends EntityProjectile {
    ...
    public boolean onUpdate(int currentTick) {
        ...
        if (this.isCollided) {
            ...
            hasUpdate = true;
            Entity[] entities =
                    this.getLevel().getNearbyEntities(this.getBoundingBox().grow(8.25, 4.24, 8.25));
