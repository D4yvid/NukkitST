...
import org.crimsonmc.block.BlockIterator;
import org.crimsonmc.entity.data.ShortEntityData;
import org.crimsonmc.entity.passive.EntityWaterAnimal;
...
import org.crimsonmc.nbt.tag.ShortTag;
...
public abstract class EntityLiving extends Entity implements EntityDamageable {
    ...
    public void attack(EntityDamageEvent source) {
        ...
        if (source instanceof EntityDamageByEntityEvent) {
            ...
            if (e.isOnFire() && !(e instanceof ServerPlayer)) {
                this.setOnFire(2 * this.server.getDifficulty());
            }

            double deltaX = this.x - e.x;
            double deltaZ = this.z - e.z;
            this.knockBack(e, source.getDamage(), deltaX, deltaZ,
                ...
                if (this instanceof EntityWaterAnimal) {
                    ...
                    if (airTicks <= -20) {
                        ...
                        EntityDamageEvent ev =
                                new EntityDamageEvent(this, EntityDamageEvent.CAUSE_SUFFOCATION, 2);
                        this.attack(ev);
                    }
    ...
    public Block[] getLineOfSight(int maxDistance, int maxLength, Map<Integer, Object> transparent) {
        return this.getLineOfSight(maxDistance, maxLength,
                transparent.keySet().stream().toArray(Integer[]::new));
    }
