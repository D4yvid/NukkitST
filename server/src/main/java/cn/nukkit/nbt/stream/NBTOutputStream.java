...
public class NBTOutputStream implements DataOutput, AutoCloseable {
  ...
  public NBTOutputStream(OutputStream stream) { this(stream, ByteOrder.BIG_ENDIAN); }

  public NBTOutputStream(OutputStream stream, ByteOrder endianness) {
    this.stream = stream instanceof DataOutputStream ? (DataOutputStream)stream
                                                     : new DataOutputStream(stream);
    this.endianness = endianness;
  }

  public ByteOrder getEndianness() { return endianness; }
