...
public class CompoundTag extends Tag {
  ...
  public Collection<Tag> getAllTags() { return tags.values(); }
  ...
  public Map<String, Tag> getTags() { return new HashMap<>(this.tags); }

  public boolean getBoolean(String name) { return getByte(name) != 0; }
   ...
   */
  public boolean exist(String name) { return tags.containsKey(name); }
}
