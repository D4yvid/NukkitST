...
public class PlayerDeathEvent extends EntityDeathEvent implements Cancellable {
  ...
  public TextContainer getDeathMessage() { return deathMessage; }

  public void setDeathMessage(TextContainer deathMessage) { this.deathMessage = deathMessage; }
  ...
  public boolean getKeepExperience() { return keepExperience; }
