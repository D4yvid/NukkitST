...
public class BanList {
  ...
  public BanList(String file) { this.file = file; }
  ...
  public BanEntry addBan(String target) { return this.addBan(target, null); }

  public BanEntry addBan(String target, String reason) { return this.addBan(target, reason, null); }
  ...
  public void load() {
    ...
    try {
      if (!file.exists()) {
        ...
        LinkedList<TreeMap<String, String>> list = new Gson().fromJson(
            Utils.readFile(this.file), new TypeToken<LinkedList<TreeMap<String, String>>>() {
  ...
  public void save() {
    ...
    try {
      ...
      Utils.writeFile(this.file,
                      new ByteArrayInputStream(
                          new GsonBuilder().setPrettyPrinting().create().toJson(list).getBytes(
