...
public class BanEntry {
  ...
  public static BanEntry fromMap(Map<String, String> map) {
    ...
    try {
      ...
      banEntry.setExpirationDate(!map.get("expireDate").equals("Forever")
  ...
  public LinkedHashMap<String, String> getMap() {
    ...
    map.put("expireDate", getExpirationDate() != null
                              ? new SimpleDateFormat(format).format(getExpirationDate())
                              : "Forever");
    map.put("reason", this.getReason());
    return map;
  }

  public String getString() { return new Gson().toJson(this.getMap()); }
}
