...
public class PlayerInventory extends BaseInventory {
  ...
  public int getHeldItemIndex() { return itemInHandIndex; }
  ...
  public boolean setItemInHand(Item item) { return this.setItem(this.getHeldItemSlot(), item); }

  public int getHeldItemSlot() { return this.getHotbarSlotIndex(this.itemInHandIndex); }
    ...
    if (slot >= -1 && slot < this.getSize()) {
      ...
      if (this.getHolder() instanceof Player) {
        PlayerItemHeldEvent ev =
            new PlayerItemHeldEvent((Player)this.getHolder(), item, slot, itemIndex);
  ...
  public int getHotbarSize() { return 9; }

  public Item getArmorItem(int index) { return this.getItem(this.getSize() + index); }

  public boolean setArmorItem(int index, Item item) {
    return this.setItem(this.getSize() + index, item);
  }

  public Item getHelmet() { return this.getItem(this.getSize()); }

  public Item getChestplate() { return this.getItem(this.getSize() + 1); }

  public Item getLeggings() { return this.getItem(this.getSize() + 2); }

  public Item getBoots() { return this.getItem(this.getSize() + 3); }

  public boolean setHelmet(Item helmet) { return this.setItem(this.getSize(), helmet); }

  public boolean setChestplate(Item chestplate) {
    return this.setItem(this.getSize() + 1, chestplate);
  }

  public boolean setLeggings(Item leggings) { return this.setItem(this.getSize() + 2, leggings); }

  public boolean setBoots(Item boots) { return this.setItem(this.getSize() + 3, boots); }
  ...
  public void sendArmorContents(Player player) { this.sendArmorContents(new Player[] {player}); }
