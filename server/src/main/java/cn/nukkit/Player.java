...
public class Player extends EntityHuman implements CommandSender, InventoryHolder, ChunkLoader, IPlayer {
    ...
    public void spawnTo(Player player) {
        if (this.isSpawned() && player.isSpawned() && this.isAlive() && player.isAlive() && player.getLevel() == this.level
    ...
    protected void sendNextChunk() {
        ...
        if (this.chunkLoadCount >= this.spawnThreshold && !this.isSpawned() && this.getTeleportPosition() == null) {
            this.doFirstSpawn();
        }
    }
    ...
    public void handleDataPacket(DataPacket packet) {
        ...
        switch (packet.pid()) {
            ...
            case ProtocolInfo.PLAYER_ACTION_PACKET:
                ...
                switch (((PlayerActionPacket) packet).action) {
                    ...
                    case PlayerActionPacket.ACTION_RELEASE_ITEM:
                        if (this.getStartAction() > -1 && this.getDataFlag(Player.DATA_FLAGS, Player.DATA_FLAG_ACTION)) {
            ...
            case ProtocolInfo.ITEM_FRAME_DROP_ITEM_PACKET:
                ...
                Vector3 vector3 = this.getTemporalVector().setComponents(itemFrameDropItemPacket.x,
