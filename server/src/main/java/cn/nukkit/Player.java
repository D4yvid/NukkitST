 ...
 */
public class Player
    extends EntityHuman implements CommandSender, InventoryHolder, ChunkLoader, IPlayer {
  ...
  @Getter protected long randomClientId = -1;

  protected Vector3 forceMovement = null;

  private Vector3 teleportPosition = null;

  @Getter protected boolean connected = true;

  @Setter protected boolean removeFormat = true;
  ...
  @Getter protected int inAirTicks = 0;

  protected int startAirTicks = 5;

  @Getter protected AdventureSettings adventureSettings;

  @Getter protected PlayerFood foodData = null;
  ...
  @Getter private Entity killer = null;

  private int hash;

  @Setter private boolean foodEnabled = true;
  ...
  public void resetInAirTicks() { this.inAirTicks = 0; }
  ...
  public boolean getRemoveFormat() { return removeFormat; }

  public void setRemoveFormat() { this.setRemoveFormat(true); }
  ...
  public boolean isSleeping() { return this.sleeping != null; }
  ...
  public void unloadChunk(int x, int z) { this.unloadChunk(x, z, null); }
   ...
   */
  public boolean dataPacket(DataPacket packet) { return this.dataPacket(packet, false) != -1; }
   ...
   * 0 is true -1 is false other is identifer
   */
  public void directDataPacket(DataPacket packet) { this.directDataPacket(packet, false); }
  ...
  public int getPing() { return this.interfaz.getNetworkLatency(this); }
  ...
  public boolean isSurvival() { return (this.gamemode & 0x01) == 0; }

  public boolean isCreative() { return (this.gamemode & 0x01) > 0; }

  public boolean isSpectator() { return this.gamemode == 3; }

  public boolean isAdventure() { return (this.gamemode & 0x02) > 0; }
  ...
  protected void processMovement(int tickDiff) {
    if (!this.isAlive() || !this.isSpawned() || this.newPosition == null ||
        this.getTeleportPosition() != null) {
      return;
    }
            ...
            if (!ev.isCancelled()) {
              ...
              if (revert) {
                this.server.getLogger().warning(this.getServer().getLanguage().translateString(
                    "nukkit.player.invalidMove", this.getName()));
              }
            }
          }
        }
    ...
    Location from =
        new Location(this.lastX, this.lastY, this.lastZ, this.lastYaw, this.lastPitch, this.level);
  ...
  protected void processLogin() {
    ...
    this.server.getLogger().info(this.getServer().getLanguage().translateString(
        "nukkit.player.logIn", TextFormat.AQUA + this.getUsername() + TextFormat.WHITE, this.ip,
        String.valueOf(this.port), String.valueOf(this.id), this.level.getName(),
        String.valueOf(NukkitMath.round(this.x, 4)), String.valueOf(NukkitMath.round(this.y, 4)),
  ...
  public void handleDataPacket(DataPacket packet) {
    ...
    case ProtocolInfo.PLAYER_ACTION_PACKET:
      ...
      case PlayerActionPacket.ACTION_RELEASE_ITEM:
        if (this.getStartAction() > -1 &&
            this.getDataFlag(Player.DATA_FLAGS, Player.DATA_FLAG_ACTION)) {
    ...
    case ProtocolInfo.INTERACT_PACKET:
      ...
      boolean cancelled =
          targetEntity instanceof Player && !((boolean)this.server.getConfig("pvp", true));
      ...
      if (targetEntity != null && this.isAlive() && targetEntity.isAlive()) {
        ...
        if (targetEntity instanceof EntityItem || targetEntity instanceof EntityArrow) {
          ...
          this.server.getLogger().warning(this.getServer().getLanguage().translateString(
              "nukkit.player.invalidEntity", this.getName()));
          break;
        }
  ...
  public boolean kick() { return this.kick(""); }

  public boolean kick(String reason) { return this.kick(reason, true); }
  ...
  public void sendTranslation(String message) { this.sendTranslation(message, new String[0]); }
  ...
  public void sendTranslation(String message, String[] parameters) {
    ...
    if (!this.server.isLanguageForced()) {
      ...
      for (int i = 0; i < parameters.length; i++) {
        parameters[i] =
            this.server.getLanguage().translateString(parameters[i], parameters, "nukkit.");
      }
  ...
  public void sendPopup(String message) { this.sendPopup(message, ""); }
  ...
  public void close(String message) { this.close(message, "generic"); }

  public void close(String message, String reason) { this.close(message, reason, true); }

  public void close(String message, String reason, boolean notify) {
    this.close(new TextContainer(message), reason, notify);
  }

  public void close(TextContainer message) { this.close(message, "generic"); }

  public void close(TextContainer message, String reason) { this.close(message, reason, true); }
  ...
  public int getExperience() { return this.exp; }

  // todo something on performance, lots of exp orbs then lots of packets, could
  // crash client

  public void setExperience(int exp) { setExperience(exp, this.getExperienceLevel()); }

  public int getExperienceLevel() { return this.expLevel; }
  ...
  public void sendExperience() { sendExperience(this.getExperience()); }
  ...
  public void sendExperienceLevel() { sendExperienceLevel(this.getExperienceLevel()); }
  ...
  public void sendPosition(Vector3 pos) { this.sendPosition(pos, this.yaw); }

  public void sendPosition(Vector3 pos, double yaw) { this.sendPosition(pos, yaw, this.pitch); }
  ...
  public int addWindow(Inventory inventory) { return this.addWindow(inventory, null); }
  ...
  public synchronized Locale getLocale() { return this.locale.get(); }

  public synchronized void setLocale(Locale locale) { this.locale.set(locale); }
  ...
  public Vector3 getTeleportPosition() { return teleportPosition; }

  public boolean isSpawned() { return spawned; }

  public void setNewPosition(Vector3 newPosition) { this.newPosition = newPosition; }

  public boolean isRiding() { return this.riding != null; }

  public Entity getRidingEntity() { return this.riding; }
  ...
  public int getStartAction() { return startAction; }

  public void setStartAction(int startAction) { this.startAction = startAction; }
}
