...
public class Effect implements Cloneable {
  ...
  @Getter protected final boolean bad;
  ...
  @Getter protected boolean ambient = false;

  public Effect(int id, String name, int r, int g, int b) { this(id, name, r, g, b, false); }
  ...
  public void setVisible(boolean visible) { this.show = visible; }
  ...
  public void add(Entity entity) { this.add(entity, false); }
