...
public class LibraryLoader {
  ...
  public static void load(String library) {
    ...
    load(new Library() {
      public String getGroupId() { return split[0]; }

      public String getArtifactId() { return split[1]; }

      public String getVersion() { return split[2]; }
    });
  }

  public static void load(Library library) {
    String filePath = library.getGroupId().replace('.', '/') + '/' + library.getArtifactId() + '/' +
                      library.getVersion();
  ...
  public static File getBaseFolder() { return BASE_FOLDER; }
}
