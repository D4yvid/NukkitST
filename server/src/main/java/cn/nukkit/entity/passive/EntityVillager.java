...
public class EntityVillager extends EntityCreature implements EntityNPC, EntityAgeable {
  ...
  public EntityVillager(FullChunk chunk, CompoundTag nbt) { super(chunk, nbt); }
  ...
  public int getProfession() { return this.namedTag.getInt("Profession"); }

  public void setProfession(int profession) { this.namedTag.putInt("Profession", profession); }
