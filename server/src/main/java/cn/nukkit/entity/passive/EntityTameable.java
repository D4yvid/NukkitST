...
public abstract class EntityTameable extends EntityAnimal implements EntityOwnable {
  ...
  public EntityTameable(FullChunk chunk, CompoundTag nbt) { super(chunk, nbt); }
  ...
  public boolean isTamed() { return (getDataPropertyByte(DATA_TAMED_FLAG) & 4) != 0; }
  ...
  public boolean isSitting() { return (getDataPropertyByte(DATA_TAMED_FLAG) & 1) != 0; }
