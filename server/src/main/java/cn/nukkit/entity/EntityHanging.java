...
public abstract class EntityHanging extends Entity {
  ...
  public EntityHanging(FullChunk chunk, CompoundTag nbt) { super(chunk, nbt); }
  ...
  public boolean onUpdate(int currentTick) {
    ...
    if (this.lastYaw != this.yaw || this.lastX != this.x || this.lastY != this.y ||
        this.lastZ != this.z) {
      this.despawnFromAll();
  ...
  protected boolean isSurfaceValid() { return true; }
}
