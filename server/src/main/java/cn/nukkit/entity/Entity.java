...
public abstract class Entity extends Location implements Metadatable {
    ...
    protected final void init(
        ...
        this.setPositionAndRotation(
                this.getTemporalVector().setComponents(
                        posList.get(0).data,
                        posList.get(1).data,
                        posList.get(2).data
                ),
    ...
    public void fall(float fallDistance) {
        ...
        if (fallDistance > 1) {
            Block down = this.level.getBlock(this.getTemporalVector().setComponents(getFloorX(), getFloorY() - 1, getFloorZ()));

            if (down.getId() == Item.FARMLAND) {
                this.level.setBlock(this.getTemporalVector().setComponents(down.x, down.y, down.z), new BlockDirt(), true, true);
            }
        }
    }
    ...
    public boolean isInsideOfWater() {
        ...
        Block block = this.level.getBlock(this.getTemporalVector().setComponents(NukkitMath.floorDouble(this.x), NukkitMath.floorDouble(y), NukkitMath.floorDouble(this.z)));
    ...
    public boolean move(
        ...
        if (this.keepMovement) {
            ...
            this.setPosition(this.getTemporalVector().setComponents((this.boundingBox.minX + this.boundingBox.maxX) / 2, this.boundingBox.minY, (this.boundingBox.minZ + this.boundingBox.maxZ) / 2));
    ...
    public Map<Integer, Player> getHasSpawned() {
        return hasSpawned;
    }
}
