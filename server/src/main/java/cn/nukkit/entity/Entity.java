...
public abstract class Entity extends Location implements Metadatable {
  ...
  public float getEyeHeight() { return this.getHeight() / 2 + 0.1f; }
  ...
  protected float getDrag() { return 0; }
  ...
  public boolean hasCustomName() { return !this.getNameTag().isEmpty(); }

  public String getNameTag() { return this.getDataPropertyString(DATA_NAMETAG); }

  public void setNameTag(String name) {
    this.setDataProperty(new StringEntityData(DATA_NAMETAG, name));
  }

  public boolean isNameTagVisible() { return this.getDataPropertyBoolean(DATA_SHOW_NAMETAG); }

  public void setNameTagVisible(boolean visible) {
    this.setDataProperty(new ByteEntityData(DATA_SHOW_NAMETAG, visible ? 1 : 0));
  }

  public void setNameTagVisible() { this.setNameTagVisible(true); }

  public boolean isSneaking() { return this.getDataFlag(DATA_FLAGS, DATA_FLAG_SNEAKING); }

  public void setSneaking(boolean value) {
    this.setDataFlag(DATA_FLAGS, DATA_FLAG_SNEAKING, value);
  }

  public void setSneaking() { this.setSneaking(true); }

  public boolean isSprinting() { return this.getDataFlag(DATA_FLAGS, DATA_FLAG_SPRINTING); }

  public void setSprinting(boolean value) {
    this.setDataFlag(DATA_FLAGS, DATA_FLAG_SPRINTING, value);
  }

  public void setSprinting() { this.setSprinting(true); }

  public Map<Integer, Effect> getEffects() { return effects; }
  ...
  public boolean hasEffect(int effectId) { return this.effects.containsKey(effectId); }
  ...
  public Map<Integer, Player> getViewers() { return hasSpawned; }
  ...
  public void sendData(Player player) { this.sendData(player, null); }
  ...
  public void sendData(Player[] players) { this.sendData(players, null); }
  ...
  public EntityDamageEvent getLastDamageCause() { return lastDamageCause; }

  public void setLastDamageCause(EntityDamageEvent type) { this.lastDamageCause = type; }
  ...
  public boolean canCollideWith(Entity entity) { return !this.justCreated && this != entity; }
  ...
  public boolean entityBaseTick() { return this.entityBaseTick(1); }
  ...
  public final void scheduleUpdate() { this.level.updateEntities.put(this.id, this); }

  public boolean isOnFire() { return this.fireTicks > 0; }
  ...
  public void resetFallDistance() { this.highestPosition = 0; }
  ...
  public Position getPosition() { return new Position(this.x, this.y, this.z, this.level); }
  ...
  protected void checkChunks() {
    if (this.chunk == null || (this.chunk.getX() != ((int)this.x >> 4)) ||
  ...
  public Vector3 getMotion() { return new Vector3(this.motionX, this.motionY, this.motionZ); }
  ...
  public boolean setDataProperty(EntityData data, boolean send) {
    if (!Objects.equals(data, this.getDataProperties().get(data.getId()))) {
      ...
      if (send)
        this.sendData(this.hasSpawned.values().stream().toArray(Player[] ::new),
  ...
  public EntityMetadata getDataProperties() { return this.dataProperties; }

  public EntityData getDataProperty(int id) { return this.getDataProperties().get(id); }

  public int getDataPropertyInt(int id) { return this.getDataProperties().getInt(id); }

  public int getDataPropertyShort(int id) { return this.getDataProperties().getShort(id); }

  public int getDataPropertyByte(int id) { return this.getDataProperties().getByte(id); }

  public boolean getDataPropertyBoolean(int id) { return this.getDataProperties().getBoolean(id); }

  public long getDataPropertyLong(int id) { return this.getDataProperties().getLong(id); }

  public String getDataPropertyString(int id) { return this.getDataProperties().getString(id); }

  public float getDataPropertyFloat(int id) { return this.getDataProperties().getFloat(id); }

  public Item getDataPropertySlot(int id) { return this.getDataProperties().getSlot(id); }

  public Vector3 getDataPropertyPos(int id) { return this.getDataProperties().getPosition(id); }

  public int getDataPropertyType(int id) {
    return this.getDataProperties().exists(id) ? this.getDataProperty(id).getType() : -1;
  }

  public void setDataFlag(int propertyId, int id) { this.setDataFlag(propertyId, id, true); }
  ...
  public Vector3 getTemporalVector() { return temporalVector; }

  public void setTemporalVector(Vector3 temporalVector) { this.temporalVector = temporalVector; }

  public Map<Integer, Player> getHasSpawned() { return hasSpawned; }
}
