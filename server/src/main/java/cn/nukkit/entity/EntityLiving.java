...
public abstract class EntityLiving extends Entity implements EntityDamageable {
  ...
  public EntityLiving(FullChunk chunk, CompoundTag nbt) { super(chunk, nbt); }
  ...
  public Item[] getDrops() { return new Item[0]; }

  public Block[] getLineOfSight(int maxDistance) { return this.getLineOfSight(maxDistance, 0); }
