...
public abstract class EntityVehicle extends Entity implements EntityRideable {
  ...
  public EntityVehicle(FullChunk chunk, CompoundTag nbt) { super(chunk, nbt); }

  public int getHurtTime() { return this.getDataPropertyInt(EntityVehicle.DATA_HURT_TIME); }
  ...
  public Entity getLinkedEntity() { return linkedEntity; }

  public void setLinkedEntity(Entity entity) { linkedEntity = entity; }
}
