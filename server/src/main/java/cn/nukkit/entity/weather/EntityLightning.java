...
public class EntityLightning extends Entity implements EntityLightningStrike {
  ...
  public EntityLightning(FullChunk chunk, CompoundTag nbt) { super(chunk, nbt); }
  ...
  public boolean isEffect() { return this.isEffect; }

  public void setEffect(boolean e) { this.isEffect = e; }
