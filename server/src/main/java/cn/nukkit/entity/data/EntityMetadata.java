...
public class EntityMetadata {
  ...
  public EntityData get(int id) { return this.getOrDefault(id, null); }
  ...
  public boolean exists(int id) { return this.map.containsKey(id); }
  ...
  public boolean getBoolean(int id) { return this.getByte(id) == 1; }

  public Item getSlot(int id) {
    return (Item)this.getOrDefault(id, new SlotEntityData(id, new ItemBlock(new BlockAir())))
        .getData();
  }
  ...
  public EntityMetadata putInt(int id, int value) { return this.put(new IntEntityData(id, value)); }
  ...
  public Map<Integer, EntityData> getMap() { return new HashMap<>(map); }
}
