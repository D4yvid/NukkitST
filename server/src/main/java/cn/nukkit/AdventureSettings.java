...
public class AdventureSettings implements Cloneable {
  ...
  public void setAutoJump(boolean autoJump) { this.autoJump = autoJump; }

  public void setCanFly(boolean canFly) { this.canFly = canFly; }

  public void setNoclip(boolean noclip) { this.noclip = noclip; }

  public boolean canDestroyBlock() { return canDestroyBlock; }

  public boolean isAutoJumpEnabled() { return autoJump; }

  public boolean canFly() { return canFly; }

  public boolean isNoclipEnabled() { return noclip; }
...
flags |= 0x20; //Show Nametags
  ...
  public static class Builder {
    ...
    public AdventureSettings build() { return this.settings; }
  }
}
