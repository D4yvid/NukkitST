...
public class GenericSound extends Sound {
  ...
  public GenericSound(Vector3 pos, int id) { this(pos, id, 0); }
  ...
  public float getPitch() { return this.pitch / 1000f; }

  public void setPitch(float pitch) { this.pitch = pitch * 1000f; }
