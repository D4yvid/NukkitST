...
public class Level implements ChunkManager, Metadatable {
  ...
  public Level(Server server, String name, String path, Class<? extends LevelProvider> provider) {
    ...
    this.server.getLogger().info(this.server.getLanguage().translateString(
        "nukkit.level.preparing", TextFormat.GREEN + this.provider.getName() + TextFormat.WHITE));
  ...
  public static long chunkHash(int x, int z) { return (((long)x) << 32) | (z & 0xffffffffL); }
  ...
  public static int chunkBlockHash(int x, int y, int z) { return (x << 11) | (z << 7) | y; }

  public static int getHashX(long hash) { return (int)(hash >> 32); }

  public static int getHashZ(long hash) { return (int)hash; }
  ...
  public int getTickRateTime() { return tickRateTime; }
  ...
  public BlockMetadataStore getBlockMetadata() { return this.blockMetadata; }

  public Server getServer() { return server; }

  final public LevelProvider getProvider() { return this.provider; }

  final public int getId() { return this.levelId; }
  ...
  public void addSound(Sound sound) { this.addSound(sound, (Player[])null); }

  public void addSound(Sound sound, Player player) { this.addSound(sound, new Player[] {player}); }
  ...
  public boolean unload() { return this.unload(false); }
  ...
  public boolean unload(boolean force) {
    ...
    this.server.getLogger().info(this.server.getLanguage().translateString(
        "nukkit.level.unloading", TextFormat.GREEN + this.getName() + TextFormat.WHITE));
  ...
  public void doTick(int currentTick) {
    ...
    for (long index : this.chunkPackets.keySet()) {
      ...
      int chunkZ = Level.getHashZ(index);
      Player[] chunkPlayers =
          this.getChunkPlayers(chunkX, chunkZ).values().stream().toArray(Player[] ::new);
  ...
  public void clearCache() { this.clearCache(false); }
  ...
  public Block[] getCollisionBlocks(AxisAlignedBB bb) { return this.getCollisionBlocks(bb, false); }
  ...
  public Block getBlock(Vector3 pos) { return this.getBlock(pos, true); }
  ...
  public boolean setBlock(Vector3 pos, Block block) { return this.setBlock(pos, block, false); }
  ...
  public void dropItem(Vector3 source, Item item) { this.dropItem(source, item, null); }
  ...
  public Item useBreakOn(Vector3 vector) { return this.useBreakOn(vector, null); }

  public Item useBreakOn(Vector3 vector, Item item) { return this.useBreakOn(vector, item, null); }
  ...
  public void dropExpOrb(Vector3 source, int exp) { dropExpOrb(source, exp, null); }
  ...
  public Entity[] getEntities() { return entities.values().stream().toArray(Entity[] ::new); }
  ...
  public Entity[] getNearbyEntities(AxisAlignedBB bb) { return this.getNearbyEntities(bb, null); }
  ...
  public Map<Long, BlockEntity> getBlockEntities() { return blockEntities; }
  ...
  public Map<Integer, ChunkLoader> getLoaders() { return loaders; }
  ...
  public Map<Long, BaseFullChunk> getChunks() { return chunks; }
  ...
  public Position getSpawnLocation() { return Position.fromObject(this.provider.getSpawn(), this); }
  ...
  public boolean loadChunk(int x, int z) { return this.loadChunk(x, z, true); }
  ...
  public boolean unloadChunkRequest(int x, int z) { return this.unloadChunkRequest(x, z, true); }
  ...
  public boolean unloadChunk(int x, int z) { return this.unloadChunk(x, z, true); }
  ...
  public boolean unloadChunk(int x, int z, boolean safe, boolean trySave) {
    ...
    try {
      ...
      logger.error(
          this.server.getLanguage().translateString("nukkit.level.chunkUnloadError", e.toString()));
  ...
  public Position getSafeSpawn() { return this.getSafeSpawn(null); }
  ...
  public String getName() { return this.provider.getName(); }
  ...
  public void setSeed(int seed) { this.provider.setSeed(seed); }

  public boolean populateChunk(int x, int z) { return this.populateChunk(x, z, false); }
  ...
  public void generateChunk(int x, int z) { this.generateChunk(x, z, false); }
  ...
  public void unloadChunks() { this.unloadChunks(false); }
  ...
  public boolean isThundering() { return isRaining() && this.thundering; }
