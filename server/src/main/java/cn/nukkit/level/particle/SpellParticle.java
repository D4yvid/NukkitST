...
/**
 * Created on 2015/12/27 by xtypr. Package cn.nukkit.level.particle in project Nukkit . The name
...
public class SpellParticle extends Particle {
  ...
  public SpellParticle(Vector3 pos) { this(pos, 0); }
  ...
  public SpellParticle(Vector3 pos, int r, int g, int b) { this(pos, r, g, b, 0x00); }
