...
public abstract class Noise {
  ...
  public static double fade(double x) { return x * x * x * (x * (x * 6 - 15) + 10); }

  public static double lerp(double x, double y, double z) { return y + x * (z - y); }

  public static double linearLerp(double x, double x1, double x2, double q0, double q1) {
    return ((x2 - x) / (x2 - x1)) * q0 + ((x - x1) / (x2 - x1)) * q1;
  }

  public static double bilinearLerp(double x, double y, double q00, double q01, double q10,
                                    double q11, double x1, double x2, double y1, double y2) {
  ...
  public static double trilinearLerp(double x, double y, double z, double q000, double q001,
    ...
    return ((z2 - z) / (z2 - z1)) *
        (dy1 * (dx1 * q000 + dx2 * q100) + dy2 * (dx1 * q001 + dx2 * q101)) +
        ((z - z1) / (z2 - z1)) *
  ...
  public double noise2D(double x, double z) { return noise2D(x, z, false); }
  ...
  public double noise3D(double x, double y, double z) { return noise3D(x, y, z, false); }
