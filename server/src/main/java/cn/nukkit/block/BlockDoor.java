...
public abstract class BlockDoor extends BlockTransparent {
  ...
  protected BlockDoor(int meta) { super(meta); }
  ...
  protected AxisAlignedBB recalculateBoundingBox() {
    ...
    AxisAlignedBB bb =
        new AxisAlignedBB(this.x, this.y, this.z, this.x + 1, this.y + 2, this.z + 1);
  ...
  public boolean place(Item item, Block block, Block target, int face, double fx, double fy,
    ...
    if (face == 1) {
      ...
      int metaUp = 0x08;
      if (next.getId() == this.getId() ||
          (!next2.isTransparent() && next.isTransparent())) { // Door hinge
        metaUp |= 0x01;
      }
  ...
  public boolean isOpen() { return (this.meta & 0x04) > 0; }
}
