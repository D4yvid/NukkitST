...
public class BlockFlower extends BlockFlowable {
  ...
  public BlockFlower() { this(0); }

  public BlockFlower(int meta) { super(meta); }
  ...
  public String getName() {
    String[] names = new String[] {"Poppy",       "Blue Orchid",  "Allium",      "Azure Bluet",
                                   "Red Tulip",   "Orange Tulip", "White Tulip", "Pink Tulip",
                                   "Oxeye Daisy", "Unknown",      "Unknown",     "Unknown",
  ...
  public int[][] getDrops(Item item) {
    return new int[][] {{this.getId(), this.meta, 1}};
  }
