...
public class BlockVine extends BlockTransparent {
  ...
  public BlockVine(int meta) { super(meta); }

  public BlockVine() { this(0); }
  ...
  protected AxisAlignedBB recalculateBoundingBox() {
    ...
    return new AxisAlignedBB(this.x + f1, this.y + f2, this.z + f3, this.x + f4, this.y + f5,
                             this.z + f6);
  }
