...
/**
 * Created on 2016/1/5 by xtypr. Package cn.nukkit.block in project nukkit . The name
 * NetherPortalBlock comes from minecraft wiki.
 */
public class BlockNetherPortal extends BlockFlowable {

  public BlockNetherPortal() { this(0); }

  public BlockNetherPortal(int meta) { super(0); }
