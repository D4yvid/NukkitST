...
public class BlockBed extends BlockTransparent {
  ...
  public BlockBed() { this(0); }

  public BlockBed(int meta) { super(meta); }
  ...
  public boolean onBreak(Item item) {
    ...
    if ((this.meta & 0x08) == 0x08) { // This is the Top part of bed
      if (blockNorth.getId() == this.getId() &&
          blockNorth.meta != 0x08) { // Checks if the block ID&&meta are right
