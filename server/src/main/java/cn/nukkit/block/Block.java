...
public abstract class Block extends Position implements Metadatable, Cloneable {
  ...
  protected Block(Integer meta) { this.meta = (meta != null ? meta : 0); }
  ...
  public static Block get(int id) { return get(id, 0); }

  public static Block get(int id, Integer meta) { return get(id, meta, null); }
  ...
  public boolean place(Item item, Block block, Block target, int face, double fx, double fy,
                       double fz, Player player) {
    return this.getLevel().setBlock(this, this, true, true);
  }

  public boolean isBreakable(Item item) { return true; }

  public int tickRate() { return 10; }

  public boolean onBreak(Item item) {
    return this.getLevel().setBlock(this, new BlockAir(), true, true);
  }

  public int onUpdate(int type) { return 0; }

  public boolean onActivate(Item item) { return this.onActivate(item, null); }

  public boolean onActivate(Item item, Player player) { return false; }

  public double getHardness() { return 10; }

  public double getResistance() { return 1; }

  public int getBurnChance() { return 0; }

  public int getBurnAbility() { return 0; }

  public int getToolType() { return ItemTool.TYPE_NONE; }

  public double getFrictionFactor() { return 0.6; }

  public int getLightLevel() { return 0; }

  public boolean canBePlaced() { return true; }
  ...
  public boolean canBeFlowedInto() { return false; }

  public boolean canBeActivated() { return false; }

  public boolean hasEntityCollision() { return false; }
  ...
  public final int getDamage() { return this.meta; }

  public final void setDamage(Integer meta) { this.meta = (meta == null ? 0 : meta & 0x0f); }
  ...
  public double getBreakTime(Item item) {
    ...
    if (this.canBeBrokenWith(item)) {
      if (this.getToolType() == ItemTool.TYPE_SHEARS && item.isShears()) {
        base /= 15;
      } else if ((this.getToolType() == ItemTool.TYPE_PICKAXE && item.isPickaxe()) ||
  ...
  public boolean canBeBrokenWith(Item item) { return this.getHardness() != -1; }

  public Block getSide(int side) { return this.getSide(side, 1); }

  public Block getSide(int side, int step) {
    if (this.isValid()) {
      return this.getLevel().getBlock(super.getSide(side, step));
    }
    return Block.get(Item.AIR, 0,
                     Position.fromObject(new Vector3(this.x, this.y, this.z).getSide(side, step)));
  }
  ...
  public MovingObjectPosition calculateIntercept(Vector3 pos1, Vector3 pos2) {
    ...
    return MovingObjectPosition.fromBlock((int)this.x, (int)this.y, (int)this.z, f,
  ...
  public int getPowerLevel(int side) { return this.getSide(side).getPowerLevel(); }

  public boolean isNeighborPowered() { return this.getNeighborPowerLevel() > 0; }
  ...
  public int getNeighborPowerLevel() {
    ...
    energy = tempLevel > energy ? tempLevel : energy;
    for (int side :
         new int[] {Vector3.SIDE_NORTH, Vector3.SIDE_SOUTH, Vector3.SIDE_WEST, Vector3.SIDE_EAST}) {
  ...
  public boolean isPowerSource() { return this.powerSource; }

  public void setPowerSource(boolean isSource) { this.powerSource = isSource; }
  ...
  public int getDropExp() { return 0; }
}
