...
public class BlockQuartz extends BlockSolid {
  ...
  public BlockQuartz() { this(0); }

  public BlockQuartz(int meta) { super(meta); }
  ...
  public String getName() {
    String[] names =
        new String[] {"Quartz Block", "Chiseled Quartz Block", "Quartz Pillar", "Quartz Pillar"};
  ...
  public int[][] getDrops(Item item) {
    if (item.isPickaxe() && item.getTier() >= ItemTool.TIER_WOODEN) {
      return new int[][] {{Item.QUARTZ_BLOCK, this.meta & 0x03, 1}};
    } else {
      return new int[0][0];
    }
  }
