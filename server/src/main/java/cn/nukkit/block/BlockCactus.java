...
public class BlockCactus extends BlockTransparent {
  ...
  public BlockCactus(int meta) { super(meta); }

  public BlockCactus() { this(0); }
  ...
  protected AxisAlignedBB recalculateBoundingBox() {
    return new AxisAlignedBB(this.x + 0.0625, this.y + 0.0625, this.z + 0.0625, this.x + 0.9375,
                             this.y + 0.9375, this.z + 0.9375);
  }
  ...
  public boolean place(Item item, Block block, Block target, int face, double fx, double fy,
    ...
    if (down.getId() == SAND || down.getId() == CACTUS) {
      ...
      if (block0.isTransparent() && block1.isTransparent() && block2.isTransparent() &&
          block3.isTransparent()) {
