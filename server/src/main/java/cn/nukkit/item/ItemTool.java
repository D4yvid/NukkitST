...
public abstract class ItemTool extends Item {
  ...
  public ItemTool(int id) { this(id, 0, 1, "Unknown"); }

  public ItemTool(int id, Integer meta) { this(id, meta, 1, "Unknown"); }

  public ItemTool(int id, Integer meta, int count) { this(id, meta, count, "Unknown"); }

  public ItemTool(int id, Integer meta, int count, String name) { super(id, meta, count, name); }
  ...
  public boolean isTool() {
    return (this.id == FLINT_STEEL || this.id == SHEARS || this.id == BOW || this.isPickaxe() ||
            this.isAxe() || this.isShovel() || this.isSword() || this.isHoe());
  }
