...
public class EnchantmentList {
  ...
  public EnchantmentList(int size) { this.enchantments = new EnchantmentEntry[size]; }
  ...
  public EnchantmentEntry getSlot(int slot) { return enchantments[slot]; }

  public int getSize() { return enchantments.length; }
}
