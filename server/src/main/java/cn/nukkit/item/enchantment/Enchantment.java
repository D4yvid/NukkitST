...
public abstract class Enchantment implements Cloneable {
  ...
  public static Enchantment getEnchantment(int id) { return get(id).clone(); }
  ...
  public void setLevel(int level) { this.setLevel(level, true); }
  ...
  public int getMaxEnchantableLevel() { return getMaxLevel(); }

  public int getMinEnchantAbility(int level) { return 1 + level * 10; }

  public int getMaxEnchantAbility(int level) { return this.getMinEnchantAbility(level) + 5; }

  public int getDamageProtection(EntityDamageEvent event) { return 0; }
  ...
  public boolean isCompatibleWith(Enchantment enchantment) { return this != enchantment; }

  public String getName() { return "%enchantment." + this.name; }

  public boolean canEnchant(Item item) { return this.type.canEnchantItem(item); }
