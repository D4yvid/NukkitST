...
public enum TextFormat {
  ...
  TextFormat(char code, int intCode) { this(code, intCode, false); }
   ...
   */
  public static TextFormat getByChar(char code) { return BY_CHAR.get(code); }
   ...
   * @return Text containing the TextFormat.ESCAPE format code character.
   */
  public static String colorize(String textToTranslate) { return colorize('&', textToTranslate); }
