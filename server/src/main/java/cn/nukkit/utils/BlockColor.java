...
public class BlockColor extends java.awt.Color {
  ...
  public BlockColor(float r, float g, float b, float a) { super(r, g, b, a); }

  public BlockColor(float r, float g, float b) { super(r, g, b); }

  public BlockColor(int rgba, boolean hasAlpha) { super(rgba, hasAlpha); }

  public BlockColor(int r, int g, int b, int a) { super(r, g, b, a); }

  public BlockColor(int rgb) { super(rgb); }

  public BlockColor(int r, int g, int b) { super(r, g, b); }
