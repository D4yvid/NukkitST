...
public class BlockIterator implements Iterator<Block> {
  ...
  private double getXLength(Vector3 direction) { return Math.abs(direction.x); }

  private double getYLength(Vector3 direction) { return Math.abs(direction.y); }

  private double getZLength(Vector3 direction) { return Math.abs(direction.z); }
