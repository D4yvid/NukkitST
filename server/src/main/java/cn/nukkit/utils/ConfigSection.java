...
public class ConfigSection extends LinkedHashMap<String, Object> {
   ...
   * @return
   */
  public ConfigSection getAll() { return new ConfigSection(this); }
   ...
   * @return
   */
  public ConfigSection getSection(String key) { return this.get(key, new ConfigSection()); }
   ...
   */
  //@formatter:on
  public ConfigSection getSections() { return getSections(null); }
   ...
   * @return
   */
  public List getList(String key, List defaultList) { return this.get(key, defaultList); }
   ...
   * @return
   */
  public boolean exists(String key) { return exists(key, false); }
   ...
   * @return
   */
  public Set<String> getKeys() { return this.getKeys(true); }
}