...
public class BlockEntitySign extends BlockEntitySpawnable {
  ...
  public boolean setText() { return this.setText(""); }

  public boolean setText(String line1) { return this.setText(line1, ""); }

  public boolean setText(String line1, String line2) { return this.setText(line1, line2, ""); }
  ...
  public String[] getText() {
    return new String[] {this.namedTag.getString("Text1"), this.namedTag.getString("Text2"),
                         this.namedTag.getString("Text3"), this.namedTag.getString("Text4")};
  }
