...
public abstract class BlockEntity extends Position {
  ...
  private static final Map<String, Class<? extends BlockEntity>> knownBlockEntities =
      new HashMap<>();
  ...
  public Block getBlock() { return this.level.getBlock(this); }

  public abstract boolean isBlockEntityValid();

  public boolean onUpdate() { return false; }

  public final void scheduleUpdate() { this.level.updateBlockEntities.put(this.id, this); }
