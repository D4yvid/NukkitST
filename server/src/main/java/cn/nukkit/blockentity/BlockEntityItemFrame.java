...
public class BlockEntityItemFrame extends BlockEntitySpawnable {
  ...
  public int getItemRotation() { return this.namedTag.getByte("ItemRotation"); }
  ...
  public void setItem(Item item) { this.setItem(item, true); }
  ...
  public float getItemDropChance() { return this.namedTag.getFloat("ItemDropChance"); }

  public void setItemDropChance(float chance) { this.namedTag.putFloat("ItemDropChance", chance); }
