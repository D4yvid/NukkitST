...
public abstract class Command {
  ...
  public Command(String name) { this(name, "", null, new String[0]); }

  public Command(String name, String description) { this(name, description, null, new String[0]); }
  ...
  public boolean isRegistered() { return this.commandMap != null; }

  public String[] getAliases() { return this.activeAliases; }
  ...
  public void setUsage(String usageMessage) { this.usageMessage = usageMessage; }
